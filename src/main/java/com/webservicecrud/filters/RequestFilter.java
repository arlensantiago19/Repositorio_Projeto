package com.webservicecrud.filters;

import com.webservicecrud.authentication.Autenticator;
import com.webservicecrud.authentication.Headers;
...
public class RequestFilter implements ContainerRequestFilter {
	...
	public void filter(ContainerRequestContext requestCtx) throws IOException {
		...
		if (!path.startsWith("teste/login")) {
