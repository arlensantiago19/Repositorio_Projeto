package com.webservicecrud.authentication;
...
public class Autenticator {
	...
	private Autenticator() {
		/**
		 * Guarda o usu�rio e senha dos clientes da API
		 */
		users.put("santiago", "teste");
		users.put("santiago2", "123");

		/**
		 * keys s�o geradas antecipadamente e disponibilizadas para os clientes da API
		 * Aqui estamos representando as keys para os dois users pr� cadastrados.
		 */
		keys.put("ece40d50-b22b-4b33-a728-343be730d85e", "santiago");
		keys.put("1ee68990-2d56-44a9-ae40-09d0bf074d8d", "santiago2");
	}
